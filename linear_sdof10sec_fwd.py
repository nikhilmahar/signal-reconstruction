...
x_physics = torch.linspace(0,total_time,3000).view(-1,1).requires_grad_(True)# sample locations over the problem domain
...
for i in range(50000):
   ...
   # yi=model(ic_data)
    ...
    loss1 =alpha*torch.mean((yh-y_data)**2)# use mean squared error
